...
public class LevelGeneration : MonoBehaviour
{
    ...
    public List<Vector2> CameraPoints = new List<Vector2>();
    ...
    void CreateRooms()
    {
        ...
        //add rooms, iterate once for number specified
        for (int i = 0; i < numberOfRooms - 1; i++)
        {

            //Math for odds (not mine, my understanding is a percentage to determine IF BRANCH, decreasing with each iteration.
    ...
    void CheckRoomDoors()
    {
        ...
        rooms[x, y].doorRight = (rooms[x + 1, y] != null);
        print("Right = " + rooms[x, y].doorRight);
